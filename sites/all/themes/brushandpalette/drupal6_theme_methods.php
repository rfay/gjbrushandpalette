...
function brushandpalette_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function brushandpalette_feed_icon($url, $title) {
 ...
 */
function brushandpalette_preprocess_comment_wrapper(&$vars) {
 ...
 */
function brushandpalette_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function brushandpalette_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function brushandpalette_button($element) {
...
*/
function brushandpalette_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function brushandpalette_node_preview($node) {
