...
function brushandpalette_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function brushandpalette_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function brushandpalette_feed_icon($url) {
 ...
 */
function brushandpalette_comment_wrapper($content, $type = null) {
  static $node_type;
