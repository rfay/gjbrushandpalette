...
function brushandpalette_process_html(&$variables) {
...
function brushandpalette_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function brushandpalette_button($variables) {
 ...
 */
function brushandpalette_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function brushandpalette_menu_local_task($variables) {
 ...
 */
function brushandpalette_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function brushandpalette_node_preview($variables) {
  $node = $variables['node'];
